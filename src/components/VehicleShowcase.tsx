...
const vehicles = [
  {
    ...
    passengers: 5,
    features: ['Premium AC', 'Window Tints', 'Professional Driver', 'Touchscreen Infotainment','2026 Model','Petrol Engine'],
  ...
  },
  {
    ...
    image: '/images/innova_2015.png',
    passengers: 7,
    features: ['Reliable Performance', 'Classic Comfort', 'Spacious Seating', 'Well Maintained', 'Smooth Travel', '2015 Model'],
    type: 'Classic MUV'
  },
  {
    name: 'Maruti Ertiga',
    image: '/images/ertiga_showroom_final.png',
    passengers: 7,
    features: ['Efficient AC','Premium Interior','7 Seater', 'Smooth Ride', 'Ample Luggage', 'Reliable Travel','2025 Model'],
    type: 'Comfort MUV'
  }
];
          ...
          <div className="h-full flex flex-col justify-between">
            ...
            <button 
              onClick={(e) => {
                ...
                window.open(`https://wa.me/919567196157?text=${msg}`, '_blank');
              }}
  ...
  return (
    <section ref={sectionRef} id="vehicles" className="py-24 relative snap-section">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <span className="text-primary text-xs font-bold uppercase tracking-widest mb-3 block">Our Fleet</span>
          <h2 className="text-4xl md:text-6xl font-black mb-4">Select Your <span className="text-primary text-glow">Ride</span></h2>
